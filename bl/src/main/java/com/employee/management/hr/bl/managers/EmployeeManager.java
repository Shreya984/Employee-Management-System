...
public class EmployeeManager implements EmployeeManagerInterface {
    ...
    public void addEmployee(EmployeeInterface employee) throws BLException {
        ...
        if(gender == '\0') blException.addException("gender", "Gender required.");
    ...
    public void updateEmployee(EmployeeInterface employee) throws BLException {
        ...
        String aadharCardNumber = employee.getAadharCardNumber();
        if(employeeID == null) {
            blException.addException("employeeID", "Employee ID is required.");
        }
        else {
            employeeID = employeeID.trim();
            if(employeeID.length() == 0) blException.addException("employeeID", "Employee ID is required.");
            else {
        ...
        if(panNumber != null && panNumber.length() > 0) {
            ...
            if(ee != null && !ee.getEmployeeID().equalsIgnoreCase(employeeID)) {
                blException.addException("panNumber", "PAN number " + panNumber + " exists.");
            }
        }
        if(aadharCardNumber != null && aadharCardNumber.length() > 0) {
